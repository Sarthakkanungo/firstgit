...
function ItemValuesInplaceholder(obj) {

    const parentElem = document.getElementById('product');
    const childELem = document.createElement('li');
    childELem.textContent = obj.ItemName + ' _ ' + obj.ItemDescription + ' _ ' + obj.ItemPrice + ' _ ' + obj.ItemQuantity - count;
...
function ListonScreen(obj) {
    ...
    buy1.onclick = () => {
        ...
        axios.put(`https://crudcrud.com/api/602873fdb3c24bcbbb0e76bd95f0cf28/GeneralStore/${obj._id}`, {
            ...
            "ItemQuantity": obj.ItemQuantity - count
        })
            .then(async (response) => {
                console.log(response);
                let gettingDetails =  await axios.get(`https://crudcrud.com/api/602873fdb3c24bcbbb0e76bd95f0cf28/GeneralStore/${obj._id}`)

                ItemValuesInplaceholder(gettingDetails.data);
